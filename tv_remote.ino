...
void loop() {
  ...
  if (key!= -1) {
    ...
    switch (key) {
      case '0':
        IrSender.sendNEC(0x20DF08F7,32);
        delay(1000);
        break;
      case '1':
        IrSender.sendNEC(0x20DF8877,32);
        delay(1000);
        break;
      case '2':
        IrSender.sendNEC(0x20DF48B7,32);
        delay(1000);
        break;
      case '3':
        IrSender.sendNEC(0x20DFC837,32);
        delay(1000);
        break;
      case '4':
        IrSender.sendNEC(0x20DF28D7,32);
        delay(1000);
        break;
      case '5':
        IrSender.sendNEC(0x20DFA857,32);
        delay(1000);
        break;
      case '6':
        IrSender.sendNEC(0x20DF6897,32);
        delay(1000);
        break;
      case '7':
        IrSender.sendNEC(0x20DFE817,32);
        delay(1000);
        break;
      case '8':
        IrSender.sendNEC(0x20DF18E7,32);
        delay(1000);
        break;
      case '9':
        IrSender.sendNEC(0x20DF9867,32);
        delay(1000);
        break;
      case 'p': //power
        ...
        break;
      case 'l': //list
        IrSender.sendNEC(0x20DFCA35,32);
        delay(1000);
        break;
      case 't': //TV
        IrSender.sendNEC(0x20DF0FF0,32);
        delay(1000);
        break;
      case 'i': //input
      ...
      case 'k': //ok
        ...
        break;
      case 'b': //back
        IrSender.sendNEC(0x20DF14EB,32);
        delay(1000);
        break;
      case 'e': //exit
        IrSender.sendNEC(0x20DFDA25,32);
        delay(1000);
        break;
      case 'x':  //stop
        IrSender.sendNEC(0x20DF8D72,32);
        delay(1000);
        break;
      case 'm':  //mute
        ...
        break;
      case 'c':  //play
        IrSender.sendNEC(0x20DF0DF2,32);
        delay(1000);
        break;
      case 'v': //pause
        IrSender.sendNEC(0x20DF5DA2,32);
        delay(1000);
        break;
      case '<': //backward
        IrSender.sendNEC(0x20DFF10E,32);
        delay(1000);
        break;
      case '>': //forward
        IrSender.sendNEC(0x20DF718E,32);
        delay(1000);
        break;
      case '?':  //AV Mode
        IrSender.sendNEC(0x20DF0CF3,32);
        delay(1000);
        break;
      case '/':  //AV
        IrSender.sendNEC(0x20DF5AA5,32);
        delay(1000);
        break;
      case 'r':  //Radio/TV
        IrSender.sendNEC(0x20DF6B94,32);
        delay(1000);
        break;
      case 'h':  //HDMI1
        IrSender.sendNEC(0x20DF738C,32);
        delay(1000);
        break;
      case '+': //Vol+
